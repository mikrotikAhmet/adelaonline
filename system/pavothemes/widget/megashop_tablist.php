<?php
class PtsWidgetMegashop_tablist extends PtsWidgetPageBuilder {

		public $name = 'megashop_tablist';
		public $group = 'product';

		public static function getWidgetInfo(){
			return array('label' => ('Megashop Get List products by tab categories'), 'explain' => 'Alow show list products by tab categories', 'group' => 'product'  );
		}
