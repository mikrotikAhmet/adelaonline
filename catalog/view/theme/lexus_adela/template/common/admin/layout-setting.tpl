...
<div class="theme-layout col-sm-8">
		...
		<div class="slideshow  edit-container clearfix"  data-position="full_slideshow">
			<div class="pos">Full Slideshow</div>
			<?php if( isset($layout_modules['full_slideshow']) ){  
				foreach( $layout_modules['full_slideshow'] as $modulepos ) {
			?>
			<div class="module-pos <?php if( !$modulepos['status']){ ?>mod-disable<?php } ?>" data-position="full_slideshow" data-id="<?php echo $modulepos['index'];?>">
				<div class="edit-module">
					<a target="_blank" href="<?php echo $ourl->link('module/'.$modulepos['code'],'token='.$token);?>"><b><?php echo $modulepos['title']; ?></b></a>
				</div>
			</div>
		...
		<div class="slideshow  edit-container clearfix"  data-position="mass_slideshow">
			<div class="pos">Mass Slideshow</div>
			<?php if( isset($layout_modules['mass_slideshow']) ){  
				foreach( $layout_modules['mass_slideshow'] as $modulepos ) {
			?>
			<div class="module-pos <?php if( !$modulepos['status']){ ?>mod-disable<?php } ?>" data-position="mass_slideshow" data-id="<?php echo $modulepos['index'];?>">
				<div class="edit-module">
					<a target="_blank" href="<?php echo $ourl->link('module/'.$modulepos['code'],'token='.$token);?>"><b><?php echo $modulepos['title']; ?></b></a>
				</div>
			</div>
