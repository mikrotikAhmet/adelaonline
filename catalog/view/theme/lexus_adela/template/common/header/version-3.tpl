 ...
 <?php  require( ThemeControlHelper::getLayoutPath( 'common/addon/topbar-v1.tpl' ) );?>    
    <div id="header-main">
      <div class="container">
        ...
        <div id="pav-mainnav" class="col-lg-9 col-md-10 col-sm-3 col-xs-12 hidden-xs hidden-sm">
    ...
    <div class="header-bottom hidden-xs hidden-sm">
      ...
      <div class="row">
      <div class="pull-left search-auto col-lg-9 col-md-8 col-sm-8 col-xs-12">
            <!-- search -->
            <?php
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 line box-cart">
