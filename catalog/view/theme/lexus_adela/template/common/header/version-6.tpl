...
<div id="header-layout" class="header-v6">
 <?php  require( ThemeControlHelper::getLayoutPath( 'common/addon/topbar-v1.tpl' ) );?>    
    <div id="header-main">
      <div class="container">
        ...
        <div id="pav-mainnav" class="col-lg-9 col-md-9 col-sm-3 col-xs-12 hidden-xs hidden-sm textdark-menu">
    ...
    <div class="header-bottom hidden-xs hidden-sm">
      ...
      <?php if(isset($verticalmenu) && !empty($verticalmenu)) { ?>
        <div class="col-lg-3 col-sm-3 col-md-3 hidden-xs hidden-sm top-verticalmenu always-hidden">
          <?php echo $verticalmenu; ?>    
        </div>
         <?php } ?>
      <div class="search-auto col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <!-- search -->
            <?php
