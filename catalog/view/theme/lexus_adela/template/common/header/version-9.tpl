...
<div id="header-layout" class="header-v9">  
   <?php  require( ThemeControlHelper::getLayoutPath( 'common/addon/topbar-v4.tpl' ) );?>
   <div id="header-main">
      <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
          <div class="payment top-box">
            <?php
              if($content=$helper->getLangConfig('widget_payment')){
              echo $content;
              }
            ?>
          </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
          <div class="delivery top-box">
            <?php
              if($content=$helper->getLangConfig('widget_delivery')){
              echo $content;
              }
            ?>
          </div>
        ...
        <div class="col-lg-3 col-md-3 col-sm-3">
          <div class="help top-box">
            <?php
              if($content=$helper->getLangConfig('widget_help')){
              echo $content;
              }
            ?>
          </div>
    ...
    <div id="header-bot">
      <div class="container">
        <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 textdark-menu">
