...
<div id="header-layout" class="header-v8">  
   <?php  require( ThemeControlHelper::getLayoutPath( 'common/addon/topbar-v3.tpl' ) );?>
   <div id="header-main">
      <div class="container">
      <div class="row">
        <div class="logo inner  col-lg-12 col-md-12 col-sm-12 text-center">
    ...
    <div class="header-bottom hidden-xs hidden-sm">      
      <div class="row">
        <div id="pav-mainnav" class="col-lg-9 col-md-6 col-sm-3 col-xs-12 hidden-xs hidden-sm textdark-menu">
