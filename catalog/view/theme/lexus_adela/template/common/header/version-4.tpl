...
<div id="header-layout" class="header-v4">  
   <?php  require( ThemeControlHelper::getLayoutPath( 'common/addon/topbar-v1.tpl' ) );?>
   <div id="header-main">
      <div class="container">
      <div class="row">
        <div id="search" class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <div class="quick-access">
                <?php echo $search; ?>
            </div>
        </div> 
        <div class="logo inner  col-lg-6 col-md-4 col-sm-4">
        ...
        <div class=" inner col-lg-3 col-md-4 col-sm-4 box-cart">
