...
<style type="text/css">
	#footer,#powered, #top, #page > header,#header-main,#header-bot,#topbar,.product-grid,.bottom-offcanvas,.compare,.wishlist,.product-info .rating,.box-product-infomation{
		display: none;
	}
