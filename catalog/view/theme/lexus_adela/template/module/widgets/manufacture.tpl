<?php $id = rand(1,10); $span =  12/$columns; ?>
   <div class="hidden-xs block widget-carousel owl-carousel-play panel-default <?php echo $addition_cls ?>  <?php if( isset($stylecls)&&$stylecls ) { ?>box-<?php echo $stylecls;?><?php } ?>">
	<?php if( $show_title ) { ?>
