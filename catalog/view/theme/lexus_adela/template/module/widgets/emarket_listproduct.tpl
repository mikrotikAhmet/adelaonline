...
<div class="widget-tablist block panel-default <?php echo $addition_cls?>">

	<!-- title + list link -->
	<?php if( $show_title ) { ?>
	<div class="panel-heading highlight pull-left"><h4 class="panel-title"><?php echo $heading_title?></h4></div>
	<?php } ?>
	<div class="pull-left hidden-xs hidden-sm tab-v6">
	...
	<div class="block-content border">
		...
		<!-- banner -->
		<?php if(!empty($banner)) { ?>
		<div class="banner effect-v10 hidden-sm hidden-xs col-md-<?php echo $col1; ?> col-lg-<?php echo $col1; ?>">
			<a href="#"><img class="img-responsive" src="<?php echo $banner; ?>" alt="img"></a>
		</div>
		<?php } ?>
		
		<div class="col-lg-<?php echo $col2; ?> col-md-<?php echo $col2; ?>">
			<div class="box-products owl-carousel-play space-top-30 space-padding-right-30" data-ride="owlcarousel">
