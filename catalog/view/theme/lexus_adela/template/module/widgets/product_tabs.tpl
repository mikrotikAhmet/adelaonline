...
<div class="widget-products product-tabs panel block panel-default <?php echo $addition_cls?> <?php if ( isset($stylecls)&&$stylecls) { ?>box-<?php echo $stylecls; ?><?php } ?>">
	<?php if( $show_title ) { ?>
		<div class="panel-heading highlight pull-left"><h4 class="panel-title"><?php echo $heading_title?></h4></div>
	<?php } ?>
	<div class="pull-left hidden-xs <?php if($tabsstyle == 'tab-v2-r'){echo "tab-v2";}else{echo $tabsstyle;}?> <?php if($tabsstyle=='tab-v2'){echo "tabs-left";}elseif($tabsstyle=='tab-v3'){echo "tabs-right";}?>">
						...
						<div class="item <?php if($k==0) {?>active<?php } ?>">
							<?php foreach( $tproducts as $i => $product ) {  $i=$i+1;?>
								...
								if ((12 % $cols) == 0) {
									...
									$value = intval(100 / $cols);					
								}

								 ?>
								  <div class="col-lg-<?php echo $value; ?> col-md-<?php echo $value; ?> col-sm-<?php echo $span;?> col-sm-3 col-xs-12 product-col">
