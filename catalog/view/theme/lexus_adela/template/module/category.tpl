  ...
  <div class="tree-menu">
    <ul id="accordion<?php echo $ckey; ?>" class="box-category list-group accordion">
      ...
      <li class="list-group-item accordion-group">
        ...
        <i class="fa fa-dot-circle-o"></i><a href="<?php echo $category['href']; ?>" class="active"><?php echo $category['name']; ?></a>
        <?php } else { ?>
        <i class="fa fa-dot-circle-o"></i><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a>
        <?php } ?>
        ...
        <ul id="collapse_<?php echo $key.$ckey ;?>" class="collapse accordion-body <?php if($category['category_id'] == $category_id) echo "in"; ?>">
          ...
          <li>
            ...
            <i class="fa fa-dot-circle-o"></i><a href="<?php echo $child['href']; ?>" class="active"><?php echo $child['name']; ?></a>
            <?php } else { ?>
            <i class="fa fa-dot-circle-o"></i><a href="<?php echo $child['href']; ?>"><?php echo $child['name']; ?></a>
            <?php } ?>
          </li>
          <?php } ?>
        </ul>
