		...
		success: function(json) {
			...
			if (json['error']) {
				if (json['error']['warning']) {
					$('.breadcrumbs').after('<div class="container"><div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error']['warning'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div></div>');
...
$(document).delegate('#button-shipping', 'click', function() {
	$.ajax({
		...
		success: function(json) {
			...
			if (json['error']) {
				$('.breadcrumbs').after('<div class="container"><div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div></div>');
