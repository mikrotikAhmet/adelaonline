    ...
    <?php echo $content_top; ?>
      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td></td>
          <?php foreach ($products as $product) { ?>
						<td class="text-center"><input type="button" value="<?php echo $button_cart; ?>" class="button btn btn-outline-inverse" onclick="cart.addcart('<?php echo $product['product_id']; ?>');" /></td>
						<?php } ?>
					</tr>
					<tr>
						<td></td>
						<?php foreach ($products as $product) { ?>
						<td class="remove text-center"><a href="<?php echo $product['remove']; ?>" class="button btn btn-outline-inverse"><?php echo $button_remove; ?></a></td>
          <?php } ?>
        </tr>
      </table>
      </div>
